const KEY="workpilot2_clean_v21";
const OLD_KEY="workpilot2_clean_v1";
...
function load(){try{return JSON.parse(localStorage.getItem(KEY))||JSON.parse(localStorage.getItem(OLD_KEY))||clone(defaults)}catch{return clone(defaults)}}
